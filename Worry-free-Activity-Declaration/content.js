    ...
    class AutoCheckManager {
        ...
        checkRow(row) {
            try {
                ...
                if (!isChecked) {
                    ...
                    // 步骤2：添加激活状态的CSS类
                    label.classList.add('CBX_active_5-120-1');
                    ...
                    // 步骤4：修改square元素的样式
                    const squareElement = label.querySelector('.CBX_square_5-120-1');
                    if (squareElement) {
                        squareElement.classList.add('CBX_active_5-120-1');
                    }

                    // 步骤5：修改icon元素的样式
                    const iconElement = label.querySelector('.CBX_iconCheck_5-120-1');
                    if (iconElement) {
                        iconElement.classList.add('CBX_active_5-120-1');
                    }
                    ...
                    const hasActiveClass = label.classList.contains('CBX_active_5-120-1');
        ...
        supplementCheckRow(row) {
            try {
                ...
                const input = label.querySelector('input[type="checkbox"]');
                const square = label.querySelector('.CBX_square_5-120-1');
                const icon = label.querySelector('.CBX_iconCheck_5-120-1');
                ...
                if (square) {
                    square.classList.add('CBX_active_5-120-1');
                }

                if (icon) {
                    icon.classList.add('CBX_active_5-120-1');
                }
