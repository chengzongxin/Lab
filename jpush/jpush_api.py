...
class JPushAPI:
    def __init__(self):
        # 配置极光推送的认证信息
        self.app_key = "d37d80b5de222298f23c5e47"
        self.master_secret = "9952dea984280b67e8b6e5bf"
...
def main():
    parser = argparse.ArgumentParser(description='极光推送工具 - 应用1')
    parser.add_argument('action', choices=['all', 'alias'], help='推送类型：all(所有用户) 或 alias(指定用户)')
